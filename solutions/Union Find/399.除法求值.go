...
// 在详细讨论之前，首先要弄清楚，什么情况下可以求值，什么情况下不可以。
// 假设x/y=2, y/w=3， y即为x,w的公共基点，x/w,或者w/x才能求值。
// 在本题中，假设存在集合u{x,y，z}, 集合u的基点为z, ,v{y,w},集合v的基点为y,
// union(x,w)合并了u,v这两个集合，同时确立了u,v两个集合元素的公共基点为z。
// 下面讲解具体的方法：
